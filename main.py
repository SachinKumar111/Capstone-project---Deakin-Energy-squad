...
def upload_file():
	...
	if request.method == 'POST':
		...
		return render_template('upload.html', filenames = filelist, image_name=image_name, selected_algorithm=selected_algorithm, RMSE=RMSE)
...
def forecast():
	...
	if selected_file == "default":
		#selected_algorithm = " "
		filelist = os.listdir( "D:\\uploads" )
		return render_template('upload.html', filenames = filelist, image_name= image_name, selected_algorithm=selected_algorithm, error = True)
	print(selected_file)
